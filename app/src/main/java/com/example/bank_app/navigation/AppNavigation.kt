package com.example.bank_app.navigation
...
import com.example.bank_app.ui.screens.auth.*
import com.example.bank_app.ui.screens.home.*
import com.example.bank_app.ui.screens.transfer.*
import com.example.bank_app.ui.screens.analytics.*
import com.example.bank_app.ui.screens.transactions.*
import com.example.bank_app.ui.screens.wallet.*
import com.example.bank_app.ui.screens.account.*
import com.example.bank_app.data.bottomNavItems
    ...
    Scaffold(
        ...
        NavHost(
            ...
            composable("Lock") {
                LockScreen(
                    onUnlock = {
                        navController.navigate("Login") { popUpTo("Lock") { inclusive = true } }
                    }
                )
            }
            composable("Login") {
            ...
            composable("SignUp") {
                SignUpScreen(
                    onSignUpClick = { navController.navigate("Home") { popUpTo("Login") { inclusive = true } } },
            ...
            composable("Home") {
                HomeContentScreen(
                    ...
                    onTransactionClick = { index -> navController.navigate("TransactionDetail/$index") },
                    showSnackbar = showSnackbar
                )
            }
            composable("Wallet") {
            ...
            composable("Notifications") { NotificationsScreen(showSnackbar = showSnackbar) }
            composable("Account") {
                AccountScreen(
                    onLogoutClick = { navController.navigate("Login") { popUpTo(0) { inclusive = true } } },
                    onSettingsClick = { navController.navigate("Settings") },
                    onHelpCenterClick = { navController.navigate("HelpCenter") },
                    showSnackbar = showSnackbar
                )
            }
            composable("HelpCenter") { HelpCenterScreen(onBackClick = { navController.popBackStack() }) }
            composable("SendMoney") { SendMoneyScreen(onBackClick = { navController.popBackStack() }, showSnackbar = showSnackbar) }
            ...
            composable(
                ...
                TransactionDetailScreen(transactionId = id, onBackClick = { navController.popBackStack() })
            }
            composable("Analytics") { AnalyticsScreen(onBackClick = { navController.popBackStack() }) }
            composable("Settings") { SettingsScreen(isDarkMode = isDarkTheme, onThemeChange = onThemeChange, onBackClick = { navController.popBackStack() }) }
            composable(
                ...
                CardDetailsScreen(cardIndex = index, onBackClick = { navController.popBackStack() })
            }
            composable("Receive") { ReceiveScreen(onBackClick = { navController.popBackStack() }, showSnackbar = showSnackbar) }
            composable("PayBills") { PayBillsScreen(onBackClick = { navController.popBackStack() }, showSnackbar = showSnackbar) }
            composable("TopUp") { TopUpScreen(onBackClick = { navController.popBackStack() }, showSnackbar = showSnackbar) }
        }
    }
}
